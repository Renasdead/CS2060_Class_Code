...
void printArray(const int[], size_t size);
...
int main(void)
{
   ...
   // Demo for %p
   printf("%s", "Demo for %p");
   printf("a[0] =  %p   &a[0] = %p ", &a, &a[0]);
   puts("");
   puts("Effects of passing entire array by reference:\n\nThe "
      "values of the original array are:");
   // Use my printArray function
   printArray(a, SIZE);
...
void printArray(const int arrayToPrint[], size_t size) {
    for (size_t index = 0; index < size; index++) {
        printf("%3d", arrayToPrint[index]);
    }
